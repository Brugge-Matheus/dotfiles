...
safe_link "$DOTFILES_DIR/hypr/scripts"       "$HOME/.config/hypr/scripts"   # lock.sh + hyprlock-media.sh (now playing)
safe_link "$DOTFILES_DIR/hypr/assets"        "$HOME/.config/hypr/assets"    # transparent.png (placeholder da capa no lockscreen)
